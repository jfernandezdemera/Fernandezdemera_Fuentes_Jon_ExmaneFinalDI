...
namespace InterfazGrafica.Formularios
{
    public partial class DashBoard : Form
    {
        ...
        private void but_Resumen_Click(object sender, EventArgs e)
        {
            ...
            panel_BaseDashboard.Controls.Remove(this.resumenUC);
            resumenUC = new ResumenUC(ControladorBLL.ListarPedidosCliente(this.clientesUC.ClinteSeleccionado.NombreCliente));
            panel_BaseDashboard.Controls.Clear();
